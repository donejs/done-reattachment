# Contributing to done-reattachment

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//done-reattachment) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork done-reattachment, you can start by going to its [fork page](https://github.com//done-reattachment/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/done-reattachment
```
